{block name="title" prepend}{$LNG.lm_universe}{/block}
{block name="script" append}{/block}
{block name="content"}
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="card mb-3">
        <h5 class="card-header">{$LNG.lm_universe}</h5>
        <div class="card-body">
        ...
        <div class="card-footer text-center">
            <p class="card-text"><a href="?page=universe&action=create&amp;sid={$SID}&amp;reload=t">{$LNG.uvs_new}</a></p>
        </div>
    </div>
</main>
{/block}