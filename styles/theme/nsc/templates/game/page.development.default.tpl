{block name="title" prepend}{$LNG.lm_development}{/block}
{block name="script"}
            ...
            <div id="build_elements" class="officier_elements gov2">
                ...
                <div id="ofic_{$ID}" class="build_box">
                    ...
                    <div class="content_box">
                        ...
                        <div class="clear"></div>
                        <form action="game.php?page=development" method="post" class="build_form">
