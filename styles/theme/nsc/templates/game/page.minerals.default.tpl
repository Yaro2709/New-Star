{block name="title" prepend}{$LNG.lm_minerals}{/block}
{block name="script"}
    ...
    {if $mineralsList}
        <div id="ally_content" class="conteiner" style="width: 100%;">
            ...
            <div id="build_elements" class="officier_elements gov2">
                {foreach $mineralsList as $ID => $Element}
                <div id="ofic_{$ID}" class="build_box">
                    <div class="head">
                        {$LNG.tech.{$ID}}
                        <font class="gov6">{$Element.level|number}</font>
                    </div>
                    <div class="content_box">
                        ...
                        <div class="clear"></div>
                        <form action="game.php?page=minerals" method="post" class="build_form">
                            ...
                            {if $Element.buyable && $Element.level > 0}
                                <form action="game.php?page=minerals" method="post" class="build_form">
                                    <div class="clear"></div>
