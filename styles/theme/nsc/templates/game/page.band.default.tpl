{block name="title" prepend}{$LNG.lm_band}{/block}
{block name="script"}
    ...
    {if $bandList}
        <div id="ally_content" class="conteiner" style="width: 100%;">
            ...
            <div id="build_elements" class="officier_elements gov2">
                {foreach $bandList as $ID => $Element}
                <div id="ofic_{$ID}" class="build_box">
                    <div class="head">               
                        {$LNG.tech.{$ID}}
                        <font class="gov6">+{$Element.level}%</font>
                    </div>
                    <div class="content_box">
                        ...
                        <div class="clear"></div>
                        <form action="game.php?page=band" method="post" class="build_form" id="Gov">
                            ...
                            {if $Element.buyable}
                                <form action="game.php?page=band" method="post" class="build_form">
                                    <div class="clear"></div>
