            ...
            <div id="build_content" class="conteiner ship_build">
                ...
                <div id="build_elements">
                    ...
                    <div class="build_elements">
                        <div id="research_{$ID}" class="build_box {if $ID == in_array($ID, $reslist.spec_tech.1)}tech1{elseif $ID == in_array($ID, $reslist.spec_tech.2)}tech2{elseif $ID == in_array($ID, $reslist.spec_tech.3)}tech3{elseif $ID == in_array($ID, $reslist.spec_tech.4)}tech4{/if} {if !$Element.techacc}required{/if} valueTest2 height164">
                            ...
                            <div class="content_box">
                                ...
                                <div class="btn_build_border">
                                    <span class="btn_build red valueTest6">{if $Element.level == 0}{$LNG.bd_build_next_level}{else}{$LNG.bd_tech_next_level}{$Element.levelToBuild + 1}{/if}</span>
                                </div>
                                {else}
                                <div class="btn_build_border">
