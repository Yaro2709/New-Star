    ...
    <div id="content">
        <div id="ally_content" class="conteiner">
            <div class="gray_stripe" style="padding-right: 0;">
                <span>{$LNG.lm_buydefense}</span>  
                {if isModuleAvailable($smarty.const.MODULE_SHIPYARD_FLEET)}
                <a href="game.php?page=shipyard&mode=defense" class="right_flank button">{$LNG.lm_shipshard}</a>
                {/if}
            </div>
            <form action="game.php?page=buyDefense" method="post">
                ...
                <div class="buy_content">
                    <div class="buy_sector buydefense">        
                        <div class="buy_id">
                        ...
                        <span class="buy_title" id="traderHead">{$LNG.lm_buydefense}</span> 
