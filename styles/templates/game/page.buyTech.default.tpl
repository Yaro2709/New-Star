...
<div id="ally_content" class="conteiner">
    ...
    <form action="game.php?page=buytech" method="post">
        ...
        <table class="tablesorter ally_ranks gray_stripe_th">
            ...
            <tr>
                <td>
                    {$LNG.bd_the_initial_cost} {$LNG.tech.921}: <span id="price" style="font-weight:bold;"></span> 			
                </td>
            </tr>
            <tr>
                <td>
                    {$LNG.bd_total} {$LNG.tech.921}: <span id="total_price_factor" style="font-weight:bold;"></span>
                </td>
            </tr>
            <tr>
