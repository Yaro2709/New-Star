    ...
    <div id="content">
        <div id="ally_content" class="conteiner">
            ...
            <div id="build_elements" class="officier_elements prem_shop">
                <div class="record_rows" style="margin: 0px 7px 4px 7px;">
                    <div class="record_img_utits" style="width: 100px;height: 40px;">
                ...
                <div class="record_rows" style="margin: 0px 7px 4px 7px;">
                    ...
                    <div class="required_blocks" style="line-height: 30px;">
