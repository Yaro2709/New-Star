...
<div id="ally_content" class="conteiner">
	...
	<input type="hidden" name="token" value="{$token}">  
    	...
    	{$LNG.fl_mission} 
		 <span class="tornaindietro fleetstep2-31"><span class="fleetstep2-3">{$LNG.fl_resources} <a style="float:right; color:#666;" href="javascript:maxResources()">Все ресурсы</a></span>
    </span>
    </div>
           ...
           <div class="fleetstep2-2">
                     <div class="fl_mission_selector">
        				...
        				<span class="fleetstep2-4">Остаток: <span id="remainingresources"><font color="lime">-</font></span></span>
                        	...
                        	<span class="fleetstep2-5">{$LNG.fl_fuel_consumption}: <span style="color:#096;">{pretty_number($consumption)}</span>
                            <span id="consumption" class="consumption" style="display:none;">{pretty_number($consumption)}</span></span>
