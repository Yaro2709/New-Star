   ...
   <div id="content">
      <div id="ally_content" class="conteiner" style="padding-bottom:2px;">
         <div class="gray_stripe" style="padding-right:0;">
            {$LNG.ti_header} <a href="game.php?page=ticket&amp;mode=create"><input type="button" class="right_flank input_blue" style="width:200px; font-weight:bold;" value="{$LNG.ti_new}"></a>
         </div>
