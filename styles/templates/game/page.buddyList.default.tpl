            ...
            <table class="tablesorter ally_ranks tabstatistica" style="margin-bottom: 5px;">
                <tbody>
                    ...
                    <tr class="classificabarra">
                        ...
                        <td class="classstat8 tooltip" style="text-align: left;width: 110px;max-width: 110px;min-width: 110px;overflow: hidden; white-space: nowrap;">{$otherRequestRow.text}</td>
