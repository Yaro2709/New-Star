   ...
   <div id="content">
      <div id="ally_content" class="conteiner">
         ...
         <table class="tablesorter ally_ranks">
            ...
            <tr>
               <th colspan="5" style="text-align:center">{$LNG.bu_partners}</th>
            </tr>
            <tr>
               <th>{$LNG.bu_player}</th>
            ...
            <tr>
               ...
               <td><a href="game.php?page=buddyList&amp;mode=accept&amp;id={$otherRequestID}"><img src="{$dpath}img/general/true.png" alt="{$LNG.bu_accept}" title="{$LNG.bu_accept}"></a><a href="game.php?page=buddyList&amp;mode=delete&amp;id={$otherRequestID}"><img src="{$dpath}img/general/false.png" alt="{$LNG.bu_decline}" title="{$LNG.bu_decline}"></a></td>
            </tr>
            {foreachelse}
            <tr>
            ...
            <tr>
               ...
               <td><a href="game.php?page=buddyList&amp;mode=delete&amp;id={$myRequestID}"><img src="{$dpath}img/general/false.png" alt="{$LNG.bu_cancel_request}" title="{$LNG.bu_cancel_request}"></a></td>
            </tr>
            {foreachelse}
            <tr>
               <td colspan="5">{$LNG.bu_no_request}</td>
            ...
            {/if}
            <tr>
               <td colspan="5" style="text-align:center">{$LNG.bu_partners}</td>
            </tr>
            <tr>
               <td>{$LNG.bu_player}</td>
               <td>{$LNG.bu_alliance}</td>
               <td>{$LNG.bu_coords}</td>
               <td>{$LNG.bu_online}</td>
               <td>{$LNG.bu_action}</td>
            </tr>
            ...
            <tr>
               ...
               <td><a href="game.php?page=buddyList&amp;mode=delete&amp;id={$myBuddyID}"><img src="{$dpath}img/general/false.png" alt="{$LNG.bu_delete}" title="{$LNG.bu_delete}"></a></td>
            </tr>
            {foreachelse}
            <tr>
