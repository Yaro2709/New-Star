...
<div id="page">
 ...
 {$currentPlanet = $GalaxyRows[$planet]}
        ...
        <span id="p_{$currentPlanet.planet.id}" class="tooltip gal_img_planet" data-tooltip-content="{$LNG.gl_planet} {$currentPlanet.planet.name} [{$galaxy}:{$system}:{$planet}]"><div class="gl-actions">
        ...
        <div class="gal_planet_name" ">{$currentPlanet.planet.name} {$currentPlanet.lastActivity} </div>
            ...
            </div><div class="gl-actions" style="top: 5px;z-index: 2;padding-left: 0px;left: 44px;">
			<table class="gl-actions-t">	
			<tbody>
			<tr>
	   ...
	   {if $currentPlanet.debris}
		...
		<div class="gal_ally_name">
				...
				{$class}>{$currentPlanet.alliance.tag}</span>
			</a>
