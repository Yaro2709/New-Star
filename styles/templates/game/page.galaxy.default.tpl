                ...
                <div id="galactic_block_1">
                    ...
                    <div class="gal_user {if $planet != 1 && $planet != 3 && $planet != 5 && $planet != 7 && $planet != 9 && $planet != 11 && $planet != 13 && $planet != 15}second{/if}">   
                        ...
                        <div class="gal_player_cont" style="float:right">
                            <a class="ico_coloni" href="?page=fleetTable&amp;galaxy={$galaxy}&amp;system={$system}&amp;planet={$planet}&amp;planettype=1&amp;target_mission=7"></a>    
                        </div>       
                    </div> 
                    ...
                    ">   
                        ...
                        {if $currentPlanet.action}
                            {if $currentPlanet.action.esp}
                                <a class="ico_watch" title="{$LNG.gl_spy}" href="javascript:doit(6,{$currentPlanet.planet.id},{$spyShips|json|escape:'html'})"></a>	
                            {/if}
                            {if $currentPlanet.action.message} 
                                <a href="#" class="ico_post" onclick="return Dialog.PM({$currentPlanet.user.id})" title="{$LNG.write_message}"></a>				      
                            {/if}
                            {if $currentPlanet.action.buddy}	
                                <a href="#" class="ico_friend" onclick="return Dialog.Buddy({$currentPlanet.user.id})" title="{$LNG.gl_buddy_request}"></a>				
                            {/if}
                        {/if}	               
                        </div> 
                    </div>
                        ...
                        <div id="diplom_content">
                            ...
                            <div class="block_2">
                                ...
                                <div class="dipl_color ally first">
                                    <div class="green"></div>
                                    <div class="color_text">Союз</div>
                                </div>
                                <div class="dipl_color ally second">
                                    <div class="white"></div>
                                    <div class="color_text">Академия</div>
                                </div>
                                <div class="dipl_color ally third">
                                    <div class="grey_yellow"></div>
                                    <div class="color_text">Торговые отношения</div>
                                </div>
                                <div class="dipl_color ally thour">
                                    <div class="brown"></div>
                                    <div class="color_text">Пакт о ненападении</div>
                                </div>
                                <div class="dipl_color ally_2 first">
                                    <div class="red"></div>
                                    <div class="color_text">Война</div>
                                </div>
                                
                                <div class="dipl_color ally_2 second">
                                    <div class="green"></div>
                                    <div class="color_text">Тайный союз</div>
                                </div>
