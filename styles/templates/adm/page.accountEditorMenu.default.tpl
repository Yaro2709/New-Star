...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    <div class="album">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    <img src="./styles/resource/images/admin/accounteditor/planets.jpg" class="card-img img-thumbnail bg-primary border-primary">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    <img src="./styles/resource/images/admin/accounteditor/alliances.jpg" class="card-img img-thumbnail bg-primary border-primary">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    <img src="./styles/resource/images/admin/accounteditor/personal.jpg" class="card-img img-thumbnail bg-primary border-primary">
                    <div class="card-body">
