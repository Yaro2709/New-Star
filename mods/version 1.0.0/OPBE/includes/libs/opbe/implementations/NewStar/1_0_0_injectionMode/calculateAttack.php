...
require ($path . 'implementations' . DIRECTORY_SEPARATOR . 'NewStar' . DIRECTORY_SEPARATOR . '1_0_0_injectionMode' . DIRECTORY_SEPARATOR . 'LangImplementation.php');
...
function getTechsFromArrayForReport($player)
{
    list($attTech, $defenceTech, $shieldTech) = getTechsFromArray($player);
    $attTech = 1 + $attTech;
    $defenceTech = 1 + $defenceTech;
    $shieldTech = 1 + $shieldTech;
